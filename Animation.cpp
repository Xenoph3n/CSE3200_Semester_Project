...
void Animation::ReadMissingBones(const aiAnimation* animation, aModel& model)
{
    ...
    auto& boneInfoMap = model.GetBoneInfoMap();//getting m_BoneInfoMap from aModel class
    int& boneCount = model.GetBoneCount(); //getting the m_BoneCounter from aModel class
